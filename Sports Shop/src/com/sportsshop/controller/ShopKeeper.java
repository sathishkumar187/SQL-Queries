...
public class ShopKeeper {
	...
	public static void addProduct(String productBrand, Product product) {
		SportsShop.showAllProducts(SHOP_SERVICE_IMPLEMENTATION.addProduct(productBrand, product));
	}
	...
	public static void updateProductPrice(String brand, String name, char size, double price) {
